        ...
        <div class="-mx-4 flex flex-wrap items-center">
          <div class="p-4 w-full lg:w-6/12">
            <NuxtImg
              ...
              class="object-none object-right hue-rotate-180 rounded-3xl"
              alt="Unsere Mission"
            />
          </div>
          <div class="mx-auto p-4 w-full lg:w-5/12">
            ...
            <h3 class="mb-2">Awarenessschulungen für Kulturschaffende</h3>
            <p class="mb-6">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus
              pulvinar faucibus neque, nec rhoncus nunc ultrices sit amet.
            </p>
            <BaseButton class="!text-black bg-white" size="xl" to="/projects">
              Mehr erfahren
            </BaseButton>
          </div>
        </div>
